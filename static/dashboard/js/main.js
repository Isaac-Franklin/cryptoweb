    ...
    .then((response) => {
      ...
      for (let i = 0; i < cryptoData.length; i++) {
        ...
        if (element1.id === "bitcoin") {
          ...
          let litecoinPriceMain = document.querySelector(
          ...
          let litecoinChangeMain = document.querySelector(
            "#litecoin-percent-change"
          );
          ...
          let ethereumPriceMain = document.querySelector(
          ...
          let ethereumChangeMain = document.querySelector(
            "#ethereum-percent-change"
          );
          ...
          let cardanoChangeMain = document.querySelector(
            "#dash-percent-change"
          );
          ...
          let rippleChangeMain = document.querySelector(
            "#ripple-percent-change"
          );
          ...
          let stakedChangeMain = document.querySelector(
            "#staked-percent-change"
          );
