...
let userSectionResponsiveOut = document.querySelector(
  ".userSectionResponsiveOut"
);
  ...
  fetch(apiAccess)
    ...
    .then((response) => {
      ...
      for (let i = 0; i < cryptoData.length - 50; i++) {
        ...
        let entryDate =
          '<div class="allscrollsection"><div class="coinandimage"><img src=" ' +
          element.image +
          ' "/>' +
          element.name +
          '</div><div class="cryptoprize"> $' +
          element.current_price.toLocaleString() +
          '</div>  Market Cap:  <div class="cryptocap">$' +
          element.market_cap.toLocaleString() +
          '</div><div class="cryptochange">' +
          element.price_change_24h +
          '%</div><div  class="cryptorank"> Rank: ' +
        ...
        document
          .querySelector(".allscrollsection2")
